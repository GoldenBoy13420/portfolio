  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-6xl px-6">
        ...
        {/* 5. Project galleries */}
        <section id="gallery" className="space-y-8 py-16">
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-blue-700">
              Project gallery
            </h3>
            <p className="mt-2 text-2xl font-semibold text-slate-900">
              Screenshots from key projects
            </p>
            <p className="mt-2 max-w-2xl text-sm text-slate-600">
              A visual overview of how the projects look and feel. Add or update
              screenshots in the future as the projects evolve.
            </p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2 rounded-2xl border border-slate-200 bg-slate-50 p-3">
              <div className="relative h-40 w-full overflow-hidden rounded-xl bg-slate-100">
                <Image
                  src="/projects/pixalyze-cover.png"
                  alt="Pixalyze upload interface"
                  fill
                  className="object-cover"
                />
              </div>
              <p className="text-xs font-semibold text-slate-800">
                Pixalyze – upload &amp; editor
              </p>
            </div>
            ...
            <div className="space-y-2 rounded-2xl border border-slate-200 bg-slate-50 p-3">
              <div className="relative h-40 w-full overflow-hidden rounded-xl bg-slate-100">
                <Image
                  src="/projects/economic-indicators.png"
                  alt="Economic indicators charts"
                  fill
                  className="object-cover"
                />
              </div>
              <p className="text-xs font-semibold text-slate-800">
                Global economic indicators – visualizations
              </p>
            </div>
            ...
            <div className="space-y-2 rounded-2xl border border-slate-200 bg-slate-50 p-3">
              <div className="relative h-40 w-full overflow-hidden rounded-xl bg-slate-100">
                <Image
                  src="/projects/cancer-mutations.png"
                  alt="Cancer mutation signature plots"
                  fill
                  className="object-cover"
                />
              </div>
              <p className="text-xs font-semibold text-slate-800">
                Cancer type classification – mutation signatures
              </p>
            </div>
          </div>

          {/* Dedicated galleries for three projects */}
          <div className="space-y-8">
            {/* Pixalyze gallery */}
            <div className="space-y-3">
              <p className="text-sm font-semibold text-slate-900">
                Pixalyze – detailed views
              </p>
              <div className="grid gap-4 md:grid-cols-3">
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/pixalyze-upload.png"
                    alt="Pixalyze upload screen"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/pixalyze-dashboard.png"
                    alt="Pixalyze dashboard with saved images"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/pixalyze-analysis.png"
                    alt="Pixalyze histogram and filters view"
                    fill
                    className="object-cover"
                  />
                </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/economic-scatter.png"
                    alt="Scatter plot of economic indicators"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/economic-boxplot.png"
                    alt="Boxplot of distributions across countries"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/economic-correlation.png"
                    alt="Correlation heatmap of indicators"
                    fill
                    className="object-cover"
                  />
                </div>
            ...
            {/* Cancer classification gallery */}
            <div className="space-y-3">
              <p className="text-sm font-semibold text-slate-900">
                Cancer type classification – results
              </p>
              <div className="grid gap-4 md:grid-cols-3">
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/cancer-confusion.png"
                    alt="Confusion matrix for cancer type classifier"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/cancer-importance.png"
                    alt="Feature importance plot for mutation signatures"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="relative h-36 w-full overflow-hidden rounded-xl bg-slate-100">
                  <Image
                    src="/projects/cancer-signatures.png"
                    alt="Visualization of mutation signatures across cancers"
                    fill
                    className="object-cover"
                  />
                </div>
